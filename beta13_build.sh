...
init_ww(){
    ...
    mkdir -p $1/android/beta/$VERSION_NO/{testsuites-embedded/{x86,arm},testsuites-shared/{x86,arm},testsuites-cordova/{x86,arm}}
    ...
    CORDOVA_TESTS_DIR=$1/android/beta/$VERSION_NO/testsuites-cordova/
...
save_Package(){
    ...
    python $ROOT_DIR/smail.py $VERSION_NO $mail_pkg_address $RELEASE_COMMIT_ID $BRANCH_NAME
